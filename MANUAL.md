...
- Botão **Buscar rádio online** — procura rádios pelo nome (via
  radios.com.br) e permite tocar na hora ou adicionar aos favoritos.
  Se o site de busca sair do ar ou mudar, esse recurso pode parar de
  funcionar, mas suas rádios já favoritadas continuam normais.
...
e VST — vale **por padrão só para músicas/arquivos locais**. Rádios
não passam por aqui, porque cada uma já vem processada do lado de
quem transmite; empilhar processamento nosso por cima soa estranho em
algumas delas. Mas isso é configurável: a opção "Usar os mesmos
efeitos nas rádios", na mesma tela do Ctrl+E, liga esse processamento
pras rádios também, pra quem preferir.
...
e rádios favoritas. Útil antes de desinstalar o programa ou trocar
de computador — exporte antes, e depois é só usar **Ajuda → Importar
todas as configurações** para recuperar tudo de uma vez, sem
...
- **Cruzamento entre faixas (crossfade)** — de 1 a 10 segundos, ou
  ...
  fim da faixa, e também na troca entre rádios favoritas.
